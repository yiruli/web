						...
						if(isset($_FILES['image']['tmp_name'])){	
				  				...
				  				if($img_size>1048576){
						  			redirect("WriteReview.php", "Sorry, image size is bigger than 1 MB. Please rewrite the review again.");
				  					  ...
				  					  $result=$db->prepare("insert into review (company, address, city, review, lng, lat, rating, water, air, waste, land, living, other, news, industry, product) values(:company, :address, :city, :review, :lng, :lat, :rating, :water, :air, :waste, :land, :living, :other, :news, :industry, :product)");					    
